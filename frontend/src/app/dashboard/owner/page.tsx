    ...
    const fetchOwnerProperties = async () => {
      try {
        const response = await fetch(
          `${BACKEND_URI}owners/${userNullifierHash}/properties`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
    ...
    <main className="min-h-[100vh] overflow-y-scoll py-12 w-full bg-brand-white dark:bg-brand-black  flex flex-col justify-center items-center bg-dot-black/[0.5] dark:bg-dot-white/[0.1] relative ">
      ...
      <div className="w-[80vw] mx-auto flex justify-center items-center gap-20 z-50">
        ...
        >
          ...
          <section className="z-50 bg-gray-50 dark:bg-gray-900">
            <div className="flex w-[90%] mx-auto flex-wrap justify-center items-center gap-10 bg-gray-50 dark:bg-gray-900">
              {ownerProperties.length > 0 ? (
                ...
                <div className="flex my-6 flex-col justify-center items-center gap-4">
                  <Image
                    src="/void.svg"
                    width={200}
                    height={200}
